<div class="border-end bg-white" id="sidebar-wrapper">
    <div class="sidebar-heading border-bottom bg-light"><img width="150px" src={{asset('profile/img/e-commerce-logo.png')}} alt=""></span></div>
    <div class="list-group list-group-flush">

        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/admin/index"><i class="fa-solid fa-gauge-high"></i> Dashboard</a>
